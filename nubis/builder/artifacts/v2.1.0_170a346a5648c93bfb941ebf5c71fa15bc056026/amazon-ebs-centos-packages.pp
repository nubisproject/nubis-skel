...
package { 'dhclient':
  ensure => '12:4.2.5-58.el7.centos.1',
}
package { 'dhcp-common':
  ensure => '12:4.2.5-58.el7.centos.1',
}
...
package { 'nfs-utils':
  ensure => '1:1.3.0-0.48.el7_4.1',
}
package { 'nginx':
  ensure => '1:1.12.2-1.el7_4.ngx',
}
package { 'nspr':
