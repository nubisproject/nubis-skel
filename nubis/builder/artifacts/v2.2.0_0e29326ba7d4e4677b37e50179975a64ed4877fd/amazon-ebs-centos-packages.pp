...
package { 'avahi-libs':
  ensure => '0.6.31-17.el7',
}
package { 'awscli':
  ensure => '1.11.133-1.el7',
}
...
package { 'cpio':
  ensure => '2.11-25.el7_4',
}
package { 'cpp':
  ensure => '4.8.5-16.el7_4.2',
}
package { 'cracklib':
  ensure => '2.9.0-11.el7',
}
...
package { 'cryptsetup-libs':
  ensure => '1.7.4-3.el7_4.1',
}
package { 'cups-client':
  ensure => '1:1.6.3-29.el7',
}
package { 'cups-libs':
  ensure => '1:1.6.3-29.el7',
}
package { 'curl':
  ensure => '7.29.0-42.el7_4.1',
}
package { 'cyrus-sasl-lib':
  ensure => '2.1.26-21.el7',
}
package { 'dbus':
  ensure => '1:1.6.12-17.el7',
}
package { 'dbus-glib':
  ensure => '0.100-7.el7',
}
...
package { 'device-mapper':
  ensure => '7:1.02.140-8.el7',
}
package { 'device-mapper-libs':
  ensure => '7:1.02.140-8.el7',
}
package { 'dhclient':
  ensure => '12:4.2.5-58.el7.centos.3',
}
package { 'dhcp-common':
  ensure => '12:4.2.5-58.el7.centos.3',
}
...
package { 'dnsmasq':
  ensure => '2.76-2.el7_4.2',
}
package { 'docutils':
  ensure => '0.11',
}
package { 'dracut':
  ensure => '033-502.el7_4.1',
}
...
package { 'fontconfig':
  ensure => '2.10.95-11.el7',
}
package { 'fontpackages-filesystem':
  ensure => '1.44-8.el7',
}
package { 'freetype':
  ensure => '2.4.11-15.el7',
}
package { 'futures':
  ensure => '3.0.5',
}
...
package { 'grub2':
  ensure => '1:2.02-0.65.el7.centos.2',
}
...
package { 'iptables':
  ensure => '1.4.21-18.3.el7_4',
}
package { 'iputils':
  ensure => '20160308-10.el7',
}
package { 'irqbalance':
  ensure => '3:1.0.7-10.el7',
}
package { 'iwl7265-firmware':
  ensure => '22.0.7.0-58.el7_4',
}
package { 'jansson':
  ensure => '2.10-1.el7',
}
...
package { 'kmod':
  ensure => '20-15.el7_4.7',
}
package { 'kmod-libs':
  ensure => '20-15.el7_4.7',
}
package { 'kpartx':
  ensure => '0.4.9-111.el7_4.2',
}
package { 'krb5-libs':
  ensure => '1.15.1-8.el7',
}
...
package { 'libattr':
  ensure => '2.4.46-12.el7',
}
package { 'libbasicobjects':
  ensure => '0.1.1-27.el7',
}
package { 'libblkid':
  ensure => '2.23.2-43.el7_4.2',
}
package { 'libcap':
  ensure => '2.22-9.el7',
}
...
package { 'libsoup':
  ensure => '2.56.0-4.el7_4',
}
package { 'libss':
  ensure => '1.42.9-10.el7',
}
package { 'libssh2':
  ensure => '1.4.3-10.el7_2.1',
}
package { 'libstdc++':
  ensure => '4.8.5-16.el7_4.2',
}
...
package { 'libteam':
  ensure => '1.25-6.el7_4.3',
}
package { 'libtevent':
  ensure => '0.9.31-2.el7_4',
}
package { 'libtiff':
  ensure => '4.0.3-27.el7_3',
}
package { 'libtirpc':
  ensure => '0.2.4-0.10.el7',
}
...
package { 'linux-firmware':
  ensure => '20170606-58.gitc990aae.el7_4',
}
package { 'locale':
  ensure => ['2.1.2'],
}
...
package { 'net-tools':
  ensure => '2.0-0.22.20131004git.el7',
}
package { 'nettle':
  ensure => '2.7.1-8.el7',
}
...
package { 'nfs-utils':
  ensure => '1:1.3.0-0.48.el7_4.2',
}
package { 'nginx':
  ensure => '1:1.12.2-2.el7',
}
...
package { 'nss':
  ensure => '3.28.4-15.el7_4',
}
package { 'nss-pem':
  ensure => '1.0.3-4.el7',
}
package { 'nss-softokn':
  ensure => '3.28.3-8.el7_4',
}
...
package { 'ntp':
  ensure => '4.2.6p5-25.el7.centos.2',
}
package { 'ntpdate':
  ensure => '4.2.6p5-25.el7.centos.2',
}
...
package { 'python-docutils':
  ensure => '0.11-0.2.20130715svn7687.el7',
}
...
package { 'python2-botocore':
  ensure => '1.6.0-1.el7',
}
package { 'python2-futures':
  ensure => '3.0.5-1.el7',
}
package { 'python2-jmespath':
  ensure => '0.9.0-3.el7',
}
package { 'python2-pip':
  ensure => '8.1.2-5.el7',
...
package { 'rsyslog':
  ensure => '8.24.0-12.el7',
}
package { 'ruby':
  ensure => '2.0.0.648-33.el7_4',
}
package { 'ruby-devel':
  ensure => '2.0.0.648-33.el7_4',
}
...
package { 'rubygem-bigdecimal':
  ensure => '1.2.0-33.el7_4',
}
package { 'rubygem-io-console':
  ensure => '0.4.2-33.el7_4',
}
package { 'rubygem-json':
  ensure => '1.7.7-33.el7_4',
}
package { 'rubygem-psych':
  ensure => '2.0.0-33.el7_4',
}
package { 'rubygem-rdoc':
  ensure => '4.0.0-33.el7_4',
}
package { 'rubygems':
  ensure => '2.0.14.1-33.el7_4',
}
package { 's3transfer':
  ensure => '0.1.10',
}
...
package { 'setools-libs':
  ensure => '3.3.8-1.1.el7',
}
package { 'setup':
  ensure => '2.8.71-7.el7',
}
package { 'shadow-utils':
  ensure => '2:4.1.5.1-24.el7',
}
...
package { 'tar':
  ensure => '2:1.26-32.el7',
}
package { 'tcl':
  ensure => '1:8.5.13-8.el7',
}
