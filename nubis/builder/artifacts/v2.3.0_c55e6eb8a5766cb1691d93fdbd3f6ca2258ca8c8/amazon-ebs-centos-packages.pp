...
package { 'curl':
  ensure => '7.29.0-46.el7',
}
package { 'cyrus-sasl-lib':
  ensure => '2.1.26-23.el7',
}
package { 'dbus':
  ensure => '1:1.10.24-7.el7',
}
package { 'dbus-glib':
  ensure => '0.100-7.el7',
}
...
package { 'linux-firmware':
  ensure => '20180220-62.2.git6d51311.el7_5',
}
package { 'locale':
  ensure => ['2.1.2'],
}
...
package { 'nfs-utils':
  ensure => '1:1.3.0-0.54.el7',
}
package { 'nginx':
  ensure => '1:1.14.0-1.el7_4.ngx',
}
package { 'nspr':
